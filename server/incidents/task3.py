    ...
    customers_truth = pd.DataFrame(
        {
            ...
            "name": ["Asha", "Ravi", "Neha", "Kabir", "Meera", "Ishaan", "Priya", "Arjun"],
            "email": [
                "asha@example.com",
                "ravi@example.com",
                "neha@example.com",
            ...
            "age": [24, 31, 29, 43, 37, 34, 28, 41],
        }
    )
    products_truth = pd.DataFrame(
        {
            "product_id": [10, 11, 12, 13, 14],
            "product_name": ["Valve", "Sensor", "Pump", "Switch", "Gateway"],
            "unit_price": [20.0, 50.0, 80.0, 35.0, 64.0],
            "category": ["hardware", "iot", "hardware", "iot", "iot"],
        }
    )
    orders_truth = pd.DataFrame(
        {
            "order_id": [201, 202, 203, 204, 205, 206, 207, 208, 209, 210],
            "customer_id": [1, 2, 3, 4, 5, 6, 7, 8, 2, 5],
            "product_id": [10, 11, 12, 13, 10, 14, 12, 11, 14, 13],
            "quantity": [2, 1, 3, 2, 5, 2, 4, 1, 3, 2],
            "order_date": [
                "2026-03-01",
                "2026-03-02",
                "2026-03-03",
